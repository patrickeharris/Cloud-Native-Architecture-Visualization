...
import scatteredData from "../../utils/antipatterns/scattered_parasitic_functionality.json";
    ...
    return (
        <div>
            <InterNodeVisLayout
                ...
                antipatternJSON={scatteredData}
            ></InterNodeVisLayout>
        </div>
    );
};

export default ScatteredParasitic;